...
if (
  !fs.existsSync(
    path.join(CONTRACTS_LINK, "paymasters/SingleRecipientPaymaster.sol")
  )
) {
  console.log(
    "== creating symlink",
    chalk.yellow(CONTRACTS_LINK + "/paymasters"),
    "for contracts"
  );
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    npmtest: {
      // used from "npm test". see package.json
